...
write_excel_csv(prop_address_list, path = "/home/kiernan/Downloads/prop_address_list.csv")
...
# Create single variable indicating neighborhood for each property entry.
tax$neighborhood <- NA
for(i in 1:length(nbh.char)){
